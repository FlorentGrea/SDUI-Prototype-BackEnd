            ...
            "contexts" to UIProperty.ListValue(listOf(
                mapOf(
                    ...
                    "contextValue" to UIProperty.MapValue(mapOf(
                        ...
                        "reRender" to UIProperty.NumberValue(1),
                    ))
                ),
                mapOf(
                ...
                children = listOf(
                    UIComponent(
                        ...
                        children = listOf(
                            UIComponent(
                                type = "SduiCall",
                                properties = mapOf("urlName" to UIProperty.StringValue("mapmarker?db=events&action=getAll"), "context" to UIProperty.StringValue("eventFilters"))
                            ),
                            mapMenu(),
                            //UIComponent(
                            //    type = "SduiCall",
                            //    props = mapOf("macroComponentName" to "MapMenu")
                            //),
                            //UIComponent(
                            //    type = "SduiCall",
                            //    props = mapOf("macroComponentName" to "EventsCard")
                            //)
                        )
                    )
                )
